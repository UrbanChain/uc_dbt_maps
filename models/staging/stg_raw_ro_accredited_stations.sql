-- models/staging/stg_raw_ro_accredited_stations.sql

with source as (
    select * from {{ source('raw_ro_accredited_stations_source', 'raw_ro_accredited_stations') }}
)
...
select
    ...
    "organization",
    "organization_contact_address" as organization_address,
