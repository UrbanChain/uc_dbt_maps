-- models/staging/stg_raw_ecr_ukpn.sql

with source as (
    select * from {{ source('raw_ecr_ukpn_1_source', 'raw_ecr_ukpn_1') }}
)
...
select
    ...
    {{ clean_value('"Point of Connection (POC)_Voltage (kV)"') }} as poc_voltage,
    ...
    "Energy Source & Energy Conversion Technology 2 - Registered Cap" as sourcetech_2,
    ...
    "Energy Source & Energy Conversion Technology 3 - Registered Cap" as sourcetech_3,
