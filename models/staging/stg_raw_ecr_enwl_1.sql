-- models/staging/stg_raw_ecr_enwl_1.sql

with source as (
    select * from {{ source('raw_ecr_enwl_1_source', 'raw_ecr_enwl_1') }}
)
...
select
    ...
    "Already connected Registered Capacity_MW" as already_connected_registered_capacity,
    ...
    "Accepted to Connect Registered Capacity_MW" as accepted_connect_registered_capacity,
    "Change to Maximum Export Capacity_MW" as change_max_export_capacity_mw,
    "Change to Maximum Export Capacity_MVA" as change_max_export_capacity_mva,
    "Change to Maximum Import Capacity_MW" as change_max_import_capacity_mw,
    "Change to Maximum Import Capacity_MVA" as change_max_import_capacity_mva,
